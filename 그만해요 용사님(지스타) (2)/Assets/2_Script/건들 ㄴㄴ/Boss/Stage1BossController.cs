...
public class Stage1BossController : MonoBehaviour {
    ...
    IEnumerator WaitCoroutine()
    {
        ...
        Vector2 pos = new Vector2(GameObject.Find("Player").transform.position.x, GameObject.Find("Player").transform.position.y - 1f);
        pos.y += 2.3f;
        pos.x += 0.3f;
        ...
        yield return new WaitForSeconds(1 / atkDelay);
        action = false;
    }
}
